...
gamma_initialization = float(raw_input("gamma_initialization is: "))    # gamma for initial f(x) 
...
iteration_initialization = float(raw_input("iteration_initialization is: "))    # iteration for initial f(x)
#gamma = 0.9
...
data1 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration_initialization+1.0)+".txt",float)
data2 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/contour/nu2_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration_initialization+1.0)+".txt",float)
data3 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/mapping/mapping_output_nu1_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration_initialization+1.0)+".txt",float)
data4 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/mapping/mapping_output_nu2_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration_initialization+1.0)+".txt",float)
contr = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration_initialization+1.0)+".txt",float)
f_x_input = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma_initialization)+"/density/f_y_calculation_newton_rapson_method_2_gamma="+str(gamma_initialization)+"_max_err_1e-10_theta="+str(theta)+"_18000points_correction4_iter"+str(iteration_initialization)+".txt",float)
f_out=file("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/f_y_calculation_newton_rapson_method_2_gamma="+str(gamma)+"_max_err_1e-10_theta="+str(theta)+"_18000points_correction4_iter1.0.txt","w")
