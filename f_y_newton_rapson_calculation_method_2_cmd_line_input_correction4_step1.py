...
data1 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter1.0.txt",float)
data2 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu2_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter1.0.txt",float)
data3 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu1_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter1.0.txt",float)
data4 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu2_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter1.0.txt",float)
contr = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter1.0.txt",float)
