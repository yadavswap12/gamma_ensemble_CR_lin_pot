...
epsi = 1e-4
data1 = numpy.loadtxt("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_gamma="+str(gamma)+"_theta="+str(theta)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt",float)
data2 = numpy.loadtxt("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu1_gamma="+str(gamma)+"_theta="+str(theta)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt",float)
data3 = numpy.loadtxt("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu2_contour_gamma="+str(gamma)+"_theta="+str(theta)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt",float)
data4 = numpy.loadtxt("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu2_gamma="+str(gamma)+"_theta="+str(theta)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt",float)
contr = numpy.loadtxt("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu_contour_gamma="+str(gamma)+"_theta="+str(theta)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt",float)

f_out=file("input_output_files/alpha_"+str(alpha)+"_rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/renormalized_density_psi_method_2_epsi=1e-4_gamma="+str(gamma)+"_theta="+str(theta)+"_rho="+str(rho)+"_soft_edge_18000points_corrected3_iter"+str(iteration)+".txt","w")
