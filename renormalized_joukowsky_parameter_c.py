...
b0=0.02667    # parameters of polynomial fit for f1(x), f1(x)=b0 + b1x + b2x^2 + b3x^3 + b4x^4 
b1=4.78795    # gamma = 0.75
b2=-9.32711
b3=27.77899
b4=-48.74857
b5=50.81956
...
rho= 2.0    # V(x)=rho*x  
c = 0.633    # from self-consistent calculation using jouwkowsky_parameters_c_selfconsistent_calculation_CR_problem.py for alpha-log(x) potential.
print c
