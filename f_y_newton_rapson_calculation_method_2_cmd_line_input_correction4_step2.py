...
data1 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration)+".txt",float)
data2 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu2_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration)+".txt",float)
data3 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu1_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration)+".txt",float)
data4 = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/mapping/mapping_output_nu2_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration)+".txt",float)
contr = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/contour/nu1_contour_c="+str(c_short)+"_theta="+str(theta)+"_18000points_iter"+str(iteration)+".txt",float)
f_x_input = numpy.loadtxt("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/f_y_calculation_newton_rapson_method_2_gamma="+str(gamma)+"_max_err_1e-10_theta="+str(theta)+"_18000points_correction4_iter"+str(iteration-1)+".txt",float)
f_out=file("input_output_files/rho_"+str(rho)+"/gamma_"+str(gamma)+"/density/f_y_calculation_newton_rapson_method_2_gamma="+str(gamma)+"_max_err_1e-10_theta="+str(theta)+"_18000points_correction4_iter"+str(iteration)+".txt","w")
