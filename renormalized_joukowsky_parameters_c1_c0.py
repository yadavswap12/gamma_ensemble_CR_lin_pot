...
theta = 2.0
c1 = 0.6   # initializatio for c1(>0), analytical solution is c1=(-2.0/rho), see page number 2439 in C.R.
c0 = 0.7    # initializatio for c0(>0,>c1), analytical solution is c0=(-rho/2.0), see page number 2439 in C.R.        
...
b0=-0.03957    # parameters of polynomial fit for f1(x), f1(x)=b0 + b1x + b2x^2 + b3x^3 + b4x^4 
b1=5.57147    # gamma = 0.76
b2=-16.63531
b3=43.59599
b4=-63.35319
b5=53.24082
...
#            return (1.0/(2.0*(math.pi)*1j))*((b0+b1*J(z)+b2*(J(z))**2.0+b3*(J(z))**3.0+b4*(J(z))**4.0+b5*(J(z))**5.0+b6*(J(z))**6.0)/(z))
    ...
    def f1(z):    # See notebook
            return (1.0/(2.0*(math.pi)*1j))*((b0+b1*J(z)+b2*(J(z))**2.0+b3*(J(z))**3.0+b4*(J(z))**4.0+b5*(J(z))**5.0+b6*(J(z))**6.0+b7*(J(z))**7.0+b8*(J(z))**8.0)/(z))
...
#            return (1.0/(2.0*(math.pi)*1j))*((b0+b1*J(z)+b2*(J(z))**2.0+b3*(J(z))**3.0+b4*(J(z))**4.0+b5*(J(z))**5.0+b6*(J(z))**6.0)/(z+1.0))            
    ...
    def f2(z):    # See notebook
            return (1.0/(2.0*(math.pi)*1j))*((b0+b1*J(z)+b2*(J(z))**2.0+b3*(J(z))**3.0+b4*(J(z))**4.0+b5*(J(z))**5.0+b6*(J(z))**6.0+b7*(J(z))**7.0+b8*(J(z))**8.0)/(z+1.0))            
                
#    F1 = ((contour_integral.contr_intgl(contr,f1)).real) - (1.0+theta)
#    F2 = ((contour_integral.contr_intgl(contr,f2)).real) - (1.0)
    
    ff[0] = ((contour_integral.contr_intgl(contr,f1)).real) - (1.0+theta)
...
#            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c1_J(z)+2.0*b2*J(z)*deriv_c1_J(z)+3.0*b3*((J(z))**2.0)*deriv_c1_J(z)+4.0*b4*((J(z))**3.0)*deriv_c1_J(z)+5.0*b5*((J(z))**4.0)*deriv_c1_J(z)+6.0*b6*((J(z))**5.0)*deriv_c1_J(z))/(z))
    ...
    def deriv_c1_f1(z):    # derivative of f1(z) w.r.t. c1
            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c1_J(z)+2.0*b2*J(z)*deriv_c1_J(z)+3.0*b3*((J(z))**2.0)*deriv_c1_J(z)+4.0*b4*((J(z))**3.0)*deriv_c1_J(z)+5.0*b5*((J(z))**4.0)*deriv_c1_J(z)+6.0*b6*((J(z))**5.0)*deriv_c1_J(z)+7.0*b7*((J(z))**6.0)*deriv_c1_J(z)+8.0*b8*((J(z))**7.0)*deriv_c1_J(z))/(z))

    jacobian[0,0] = (contour_integral.contr_intgl(contr,deriv_c1_f1)).real    # for J(1,1), See notebook 
...
#            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c0_J(z)+2.0*b2*J(z)*deriv_c0_J(z)+3.0*b3*((J(z))**2.0)*deriv_c0_J(z)+4.0*b4*((J(z))**3.0)*deriv_c0_J(z)+5.0*b5*((J(z))**4.0)*deriv_c0_J(z)+6.0*b6*((J(z))**5.0)*deriv_c0_J(z))/(z))   
    ...
    def deriv_c0_f1(z):    # derivative of f1(z) w.r.t. c0
            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c0_J(z)+2.0*b2*J(z)*deriv_c0_J(z)+3.0*b3*((J(z))**2.0)*deriv_c0_J(z)+4.0*b4*((J(z))**3.0)*deriv_c0_J(z)+5.0*b5*((J(z))**4.0)*deriv_c0_J(z)+6.0*b6*((J(z))**5.0)*deriv_c0_J(z)+7.0*b7*((J(z))**6.0)*deriv_c0_J(z)+8.0*b8*((J(z))**7.0)*deriv_c0_J(z))/(z))   
...
#            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c1_J(z)+2.0*b2*J(z)*deriv_c1_J(z)+3.0*b3*((J(z))**2.0)*deriv_c1_J(z)+4.0*b4*((J(z))**3.0)*deriv_c1_J(z)+5.0*b5*((J(z))**4.0)*deriv_c1_J(z)+6.0*b6*((J(z))**5.0)*deriv_c1_J(z))/(z+1.0))
    ...
    def deriv_c1_f2(z):    # derivative of f2(z) w.r.t. c1
            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c1_J(z)+2.0*b2*J(z)*deriv_c1_J(z)+3.0*b3*((J(z))**2.0)*deriv_c1_J(z)+4.0*b4*((J(z))**3.0)*deriv_c1_J(z)+5.0*b5*((J(z))**4.0)*deriv_c1_J(z)+6.0*b6*((J(z))**5.0)*deriv_c1_J(z)+7.0*b7*((J(z))**6.0)*deriv_c1_J(z)+8.0*b8*((J(z))**7.0)*deriv_c1_J(z))/(z+1.0))
...
#            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c0_J(z)+2.0*b2*J(z)*deriv_c0_J(z)+3.0*b3*((J(z))**2.0)*deriv_c0_J(z)+4.0*b4*((J(z))**3.0)*deriv_c0_J(z)+5.0*b5*((J(z))**4.0)*deriv_c0_J(z)+6.0*b6*((J(z))**5.0)*deriv_c0_J(z))/(z+1.0))             
    ...
    def deriv_c0_f2(z):    # derivative of f2(z) w.r.t. c0
            return (1.0/(2.0*(math.pi)*1j))*((b1*deriv_c0_J(z)+2.0*b2*J(z)*deriv_c0_J(z)+3.0*b3*((J(z))**2.0)*deriv_c0_J(z)+4.0*b4*((J(z))**3.0)*deriv_c0_J(z)+5.0*b5*((J(z))**4.0)*deriv_c0_J(z)+6.0*b6*((J(z))**5.0)*deriv_c0_J(z)+7.0*b7*((J(z))**6.0)*deriv_c0_J(z)+8.0*b8*((J(z))**7.0)*deriv_c0_J(z))/(z+1.0))             
